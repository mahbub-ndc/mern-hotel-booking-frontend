...
import { searchHotels } from "../api/global-api";
...
export const Search = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5 container-fluid px-5 md:container mx-auto py-5">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-3 w-full md:flex-row md:justify-between">
